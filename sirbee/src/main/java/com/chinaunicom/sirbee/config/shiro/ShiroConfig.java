...
//
//
//import com.chinaunicom.sirbee.config.shiro.listener.ShiroSessionListener;
...
//
//        // 设置免认证 url
////        String[] anonUrls =StringUtils.split(febsProperties.getShiro().getAnonUrl(),",");
////        String[] anonUrls={};
...
//        // 设置 cookie 的过期时间，单位为秒，这里为一天    febsProperties.getShiro().getCookieTimeout()
...
////        // 设置session超时时间，单位为毫秒     febsProperties.getShiro().getSessionTimeout()
